...
export class Backend implements backendInterface {
    ...
    async addProduct(arg0: string, arg1: string, arg2: number, arg3: string, arg4: Array<string>, arg5: Array<string>, arg6: bigint, arg7: boolean, arg8: boolean): Promise<void> {
        if (this.processError) {
            try {
    ...
    async getAllProducts(arg0: string | null, arg1: boolean | null, arg2: boolean | null, arg3: string | null, arg4: boolean | null): Promise<Array<Product>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllProducts(to_candid_opt_n8(this._uploadFile, this._downloadFile, arg0), to_candid_opt_n9(this._uploadFile, this._downloadFile, arg1), to_candid_opt_n9(this._uploadFile, this._downloadFile, arg2), to_candid_opt_n8(this._uploadFile, this._downloadFile, arg3), to_candid_opt_n9(this._uploadFile, this._downloadFile, arg4));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function to_candid_opt_n9(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: boolean | null): [] | [boolean] {
    return value === null ? candid_none() : candid_some(value);
}
